...
import csv
import re
from auth.const import access_key, access_secret, consumer_key, consumer_secret
...
class twitterAPI:
    ...
    def get_all_tweets_user(self, screen_name, api):
        alltweets = []
    ...
    def get_all_tweets_keyword(self, keyword, api):
